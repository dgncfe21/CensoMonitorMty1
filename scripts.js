...
var cars_Ref = firebase.database().ref('/LAMPARAS_E1vNte');


var dataConductores = firebase.database().ref('/LAMPARAS_E1vNte');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E1vNte');
